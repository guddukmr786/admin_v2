...
}elseif ($_SESSION['s_id'] != session_id() && $_SESSION['ip_ad'] != $_SERVER['REMOTE_ADDR']) {
                        ...
                        <form class="stdform" action="change_password.php" id="change_password_form" method="post" enctype="multipart/form-data">
                           ...
                           <div class="field">
                            ...
                            <div class="field">
                             ...
                             <p style="margin-left:189px;">Password must have at least  one number(0-9), one letter [a - z], one of the following: !@#$% , Minimum lenght 6 and maximum 25</p>
                            <div class="footer">

...
$previleages = explode('|',$_COOKIE['previleges']);
...
<head>
    ...
    <!--<link href="../entry/font-awesome-4.5.0/css/font-awesome.css"  rel="stylesheet"/>-->
    <link rel="stylesheet" href="../entry/css/bootstrap.css" />
</head>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-8" style="float: right;">
                    <div class="field">
                        <label class="main1" style="font-family: sans-serif!important;">Select Hotel</label>
                 ...
                 <div class="field">
                    ...
                    <select name="hotel" id="selectt" class="hotel">
                       ...
                       <?php
                          ...
                          ?>
                       <option value="<?php echo $all_hotel['hotel_id'];?>"<?php if($_COOKIE['hotel_id'] == $all_hotel['hotel_id']) echo 'selected="selected"';?>><?php echo $all_hotel['hotel_name'];?></option>
                       <?php } else {?>
                       <option value="<?php echo $all_hotel['hotel_id'];?>"><?php echo $all_hotel['hotel_name'];?></option>
                       <?php } } ?>
                    </select>
                 </div>
              </div>

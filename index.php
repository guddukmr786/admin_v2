...
<body>
	...
	<div class="main">
		...
		<div class="login-form">
			<div class="login-left">
				...
				<div class="social-icons">
					<ul>
						<li><a href="https://www.facebook.com/www.checkinroom.in/" target="_blank"><img src="images/i1.png" alt=""/></a></li>
						<li><a href="https://twitter.com/room_check" target="_blank" class="twt"><img src="images/i2.png" alt=""/></a></li>
				...
				<div class="sap_tabs">
					<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						<ul class="resp-tabs-list">
							<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>Welcome To Check In Room</span><img width="35px;" height="20px;" src="line.png" title=""></td>&nbsp; <a target="_blank" href="http://app.axisrooms.com/accounts/checkInRoomLogin.html">Axis Rooms</a></li>
							...
							<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
								<div class="login-top">
									...
									<form method="post" action="#" name="login_form" id="login_form">
										<input type="text" class="email" name="username" id="username" value="<?php if(isset($_COOKIES['username'])) echo $_COOKIES['username']; ?>" placeholder="Username" required/>
										<input type="password" class="password" name="password" id="password" value="<?php if(isset($_COOKIES['password'])) echo $_COOKIES['password']; ?>" placeholder="Password" required />	
										...
										<div style="margin-top:49px;" class="login-bottom login-bottom1">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<a style="padding: 8px 12px!important;background-color: #0e3070;border-color: #0e3070;" type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal">Forgotten your password?</a>
										</div>
										<p>&nbsp;</p>
									</form>
								</div>
		...
		<div class="modal fade" id="myModal" role="dialog">
		      ...
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
					...
					<form method="post" action="#" name="login_form" id="login_form">
						...
						<input style="width:300px;padding: 5px 5px 5px 5px;" type="text" placeholder="Enter your E-mail ID" class="password" name="email" id="email" value="" required />
			...
			<!--//main -->	
		<div class="copyright">
			<p> &copy; 2015 <strong>Check In Room </strong>. All rights reserved | Design by : <a href="http://digitalindiawebsolutions.com/" target="_blank" ><strong>Digital India Web Solutions</strong></a></p>
		</div>	
	</body>
	</html>
	<script type="text/javascript">
		$("#forgot").click(function(){
			...
			$.ajax({
				...
				success:function(res){
					if(res == 0){
						$('.mess').html('<div class="alert alert-success">Password reset link has been sent to your registered E-mail ID please check your email.</div>');
						$("#email").val('');
					}else{

...
<div class="content">
  ...
  <form class="form-group" action="#" method="post" role="form" name="travels_form" id="travels_form" autocomplete="off">
    <div class="form-group">
      ...
      <div class="col-sm-4" style="padding-left:0px">
          <select id="party" name="party" class="form-control">
            ...
            ?>
            <option value="<?php echo $party['party_id']?>"<?php if($party['party_id'] == $invoice_up['party_id']) echo 'selected="selected"';?>><?php echo $party['name']?></option>
            <?php } else { ?>
            <option value="<?php echo $party['party_id']?>"><?php echo $party['name']?></option>
            <?php } } ?>
          </select>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4" style="padding-left:0px">
          <input type="text" id="invoice_date" name="invoice_date" value="<?php if(!empty($invoice_up['invoice_date'])) echo $invoice_up['invoice_date'];?>" placeholder="dd/mm/yyyy" class="form-control date-pick ipt" autofocus>
      </div>
      ...
      <tbody>
        ...
        <tr id='addr<?php echo $i;?>'>
          <td style="width: 200px!important;">
            <input  type="text" name="description[]" class="form-control ipt" id="description"  placeholder="" />
          </td>
          <td >
...
<script type="text/javascript">
  ...
  $(document).on('click','#igst,#cgst,#sgst,#total,#subtotal,#comm,#cgstcm,#sgstcm',function(){
    var total = 0;
...
/*function subTatoal() {  
  var val1 = parseFloat(document.getElementById("cgst").value);
  var val2 = parseFloat(document.getElementById("sgst").value);
  //var val3 = parseFloat(document.getElementById("gst").value);
  var val4 = parseFloat(document.getElementById("amount").value);
  var totalComm = document.getElementById("total");
  totalComm.value = val1 + val2 + val4;
}*/
...
<script>
  ...
  $("#travel_btn").click(function(){
    ...
    $.ajax({
      url : 'insert_data.php?type=travel_details',
      data : formData,
      type : 'post',
      async: false,
      cache: false,

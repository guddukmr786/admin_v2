...
if(isset($_GET["page"]))
  ...
  $travel = $obj->getTravelDetails($setLimit, $pageLimit);

if(isset($_GET['edit']) && $_GET['edit'] == 'y'){
  $id = $_GET['id'];
  $traveldetails = $obj->getTravelId($id);
...
<div class="content">
	<div class="idealsteps-container">
		<form action="" class="idealforms" id="travel_details" enctype="multipart/form-data" method="post" role="form" name="travel_details" >
			<div class="idealsteps-wrap">
				<!-- Step 1 -->
				<section class="idealsteps-step" data-step="0">
					<h4>Travel Agent Detalis</h4>
					<div id="message"></div>
					<div class="field">
						<input type="hidden" name="id" value="<?php if(!empty($_GET['id'])) echo $_GET['id']; ?>">
						<label class="main">Company Name<span style="color:red;">* </span>:</label>
						<?php if(isset($_SESSION['name'])) { ?>
						<input name="name" id="name"  value="<?php echo $_SESSION['name'];?>" type="text" class="ipt"  placeholder="Enter Name / name number">
						<?php } else { ?>
						<input name="name" id="name" type="text" value="<?php if(isset($traveldetails['name'])) echo $traveldetails['name']; ?>" class="ipt"  placeholder="Enter Name">
						<?php } ?>
					</div>
					<div class="field">
						<label class="main">Contact Person<span style="color:red;">* </span>:</label>
						<?php if(isset($_SESSION['contp'])) { ?>
						<input name="contp" id="contp"  value="<?php echo $_SESSION['contp'];?>" type="text" class="ipt"  placeholder="Contact Person Name">
						<?php } else { ?>
						<input name="contp" id="contp" type="text" value="<?php if(isset($traveldetails['contp'])) echo $traveldetails['contp']; ?>" class="ipt"  placeholder="Contact Person Name">
						<?php } ?>
					</div>
					<div class="field">
						<label class="main">Contact Person Designation<span style="color:red;">* </span>:</label>
						<?php if(isset($_SESSION['contact_p_desi'])) { ?>
						<input name="cont_desi" id="cont_desi"  value="<?php echo $_SESSION['contact_p_desi'];?>" type="text" class="ipt"  placeholder="Contact Person Designation">
						<?php } else { ?>
						<input name="cont_desi" id="cont_desi" type="text" value="<?php if(isset($traveldetails['contact_p_desi'])) echo $traveldetails['contact_p_desi']; ?>" class="ipt"  placeholder="Contact Person Designation">
						<?php } ?>
					</div>
					<div class="field">
						...
						<?php } else { ?>
						<input name="maillist" id="maillist" type="text" value="<?php if(isset($traveldetails['mailid'])) echo str_replace('<br>',',',$traveldetails['mailid']); ?>" class="ipt"  placeholder="Multipal email sepereate by comma(,)">
						<?php } ?>
						</br>
					...
					<div class="field">
						...
						<?php } else { ?>
						<input name="contactno" id="contactno" type="text" value="<?php if(isset($traveldetails['contactno'])) echo $traveldetails['contactno']; ?>" class="ipt"  placeholder="Contact Number"></br>
						<?php } ?>
					</div>
					<div class="field">
						<label class="main">Address<span style="color:red;">* </span>:</label>
						<?php if(isset($_SESSION['address'])) { ?>
						<input name="address" id="address"  value="<?php echo $_SESSION['address'];?>" type="text" class="ipt"  placeholder="Address"></br>
						<?php } else { ?>
						<input name="address" id="address" type="text" value="<?php if(isset($traveldetails['location'])) echo $traveldetails['location']; ?>" class="ipt"  placeholder="Address"></br>
						<?php } ?>
					</div>
					<div class="clear"></div>
					<div class="field">
						...
						<input name="city" id="city" value="<?php echo $_SESSION['city'];?>" type="text" class="ipt"  placeholder="City" autocomplete="off"></br>
						<?php } else { ?>
						<input name="city" id="city" type="text" value="<?php if(isset($traveldetails['city'])) echo $traveldetails['city']; ?>" class="ipt"  placeholder="City" autocomplete="off"></br>
						<?php } ?>
					...
					<div class="field">
						...
						<input name="state" id="state"  value="<?php echo $_SESSION['state'];?>" type="text" class="ipt"  placeholder="state" autocomplete="off"></br>
						<?php } else { ?>
						<input name="state" id="state" type="text" value="<?php if(isset($traveldetails['state'])) echo $traveldetails['state']; ?>" class="ipt"  placeholder="state" autocomplete="off"></br>
						<?php } ?>
					...
					<div class="field">
						...
						<?php } else { ?>
						<input name="pincode" id="pincode" type="text" value="<?php if(isset($traveldetails['pincode'])) echo $traveldetails['pincode']; ?>" class="ipt"  placeholder="Pincode"></br>
						<?php } ?>
					</div>
					<div class="field">
						<label class="main">Country<span style="color:red;">* </span>:</label>
						<?php if(isset($_SESSION['country'])) { ?>
						<input name="country" id="country"  value="<?php echo $_SESSION['country'];?>" type="text" class="ipt"  placeholder="Country" autocomplete="off"></br>
						<?php } else { ?>
						<input name="country" id="country" type="text" value="<?php if(isset($traveldetails['country'])) echo $traveldetails['country']; ?>" class="ipt"  placeholder="Country" autocomplete="off"></br>
						<?php } ?>
					...
					<div class="field">
						...
						<?php } else { ?>
						<input name="website" id="website" type="text" value="<?php if(isset($traveldetails['website'])) echo $traveldetails['website']; ?>" class="ipt"  placeholder="Enter website"></br>
						<?php } ?>
					</div>
					...
					<div class="footer">
						<div class="field buttons">
							...
							<input type="button" id="travel" name="travel" class="next" value="Submit" />
	...
	<div id="tablewrapper">
		<div id="tableheader">
		    ...
		    <div ><a class="button blue" id="download" href="download_data.php?type=travel_emails">Download Email</a></div>
		</div>
		    	...
		    	<table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable" width="100%">
	                <thead>
	                 ...
	                 <tbody>
	                    <?php 
	                        $i=1;
	                            foreach ($travel as $hot_category) {
	                            $location = "";
	                            $location = $hot_category['location'];
	                    ...
	                    ?>
	                    <tr id="<?php echo $hot_category['id'];?>">
		                    <td><?php echo $i++;?></td>
		                    <td><?php echo $hot_category['name'];?></td>
		                   	<td><?php echo $hot_category['contp'];?></td>
		                    <td><?php echo $hot_category['mailid'];?></td>
		                    <td><?php echo $hot_category['contactno'];?></td> 
		                    <td><?php echo $location;?></td> 
		                    <td><?php echo $hot_category['website'];?></td> 
		                    <td class="name" style="width:80px;">
		                        <a href="travelagent.php?edit=y&id=<?php echo $hot_category['id'];?>" class="btn">Edit</a>
		                    </td>
		                    <td class="name" style="width:80px;"><a href="#" class="delete" title="<?php echo $hot_category['id'];?>" id="btn_r1">Delete</a></td>
	                    </tr>
	                    <?php } ?>
	                </tbody>
	             </table>
	              <?php   
	              		echo $pg_obj->displayTravelPagination($setLimit, $page);
	              ?>
	        </section>
        </div>
        <div id="tablesearch">
	...
	$(".hotel").change(function(){
      	...
      	$.ajax({
          	...
          	success:function(data){
            	window.location.href='travelagent.php';
          	}
      	});
   	});
...
<script type="text/javascript">
	$("#travel").click(function(event){
        ...
        var formData = new FormData($("#travel_details")[0]);
        
        $.ajax({
          	url: 'insert_data.php?type=travel_agent',
          	type: 'POST', 
          	data: formData,
          	async: false,
          	cache: false,
